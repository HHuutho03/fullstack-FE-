...
import { postAddNewSpecial } from "../../../services/userService";
...
class specialtyManage extends Component {
  ...
  handleSaveNewSpecial = async () => {
    let res = await postAddNewSpecial(this.state);
    if (res && res.errCode === 0) {
      ...
      toast.error("add new special error");
    }
  };
  render() {
    return (
